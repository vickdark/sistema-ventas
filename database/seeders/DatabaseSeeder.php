...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $permissions = [
            ...
            ['nombre' => 'Cajas', 'slug' => 'cash-registers.index', 'is_menu' => 1, 'icon' => 'fa-solid fa-vault', 'module' => 'Ventas', 'order' => 26, 'descripcion' => 'Permite Ver Caja en el sistema'],
            ...
            ['nombre' => 'Cuentas por Pagar', 'slug' => 'supplier-payments.index', 'is_menu' => 1, 'icon' => 'fa-solid fa-money-bill-transfer', 'module' => 'Inventario', 'order' => 14, 'descripcion' => 'Permite Ver Cuentas por Pagar en el sistema'],
            ['nombre' => 'Crear Abono a Proveedor', 'slug' => 'supplier-payments.create', 'is_menu' => 0, 'icon' => 'fa-solid fa-money-bill-transfer', 'module' => 'Inventario', 'order' => 14, 'descripcion' => 'Permite Crear Abono a Proveedor en el sistema'],
            ['nombre' => 'Guardar Abono a Proveedor', 'slug' => 'supplier-payments.store', 'is_menu' => 0, 'icon' => 'fa-solid fa-money-bill-transfer', 'module' => 'Inventario', 'order' => 14, 'descripcion' => 'Permite Guardar Abono a Proveedor en el sistema'],
            ['nombre' => 'Ver Detalle Abono a Proveedor', 'slug' => 'supplier-payments.show', 'is_menu' => 0, 'icon' => 'fa-solid fa-money-bill-transfer', 'module' => 'Inventario', 'order' => 14, 'descripcion' => 'Permite Ver Detalle Abono a Proveedor en el sistema'],
            ['nombre' => 'Editar Abono a Proveedor', 'slug' => 'supplier-payments.edit', 'is_menu' => 0, 'icon' => 'fa-solid fa-money-bill-transfer', 'module' => 'Inventario', 'order' => 14, 'descripcion' => 'Permite Editar Abono a Proveedor en el sistema'],
            ['nombre' => 'Actualizar Abono a Proveedor', 'slug' => 'supplier-payments.update', 'is_menu' => 0, 'icon' => 'fa-solid fa-money-bill-transfer', 'module' => 'Inventario', 'order' => 14, 'descripcion' => 'Permite Actualizar Abono a Proveedor en el sistema'],
            ['nombre' => 'Eliminar Abono a Proveedor', 'slug' => 'supplier-payments.destroy', 'is_menu' => 0, 'icon' => 'fa-solid fa-money-bill-transfer', 'module' => 'Inventario', 'order' => 14, 'descripcion' => 'Permite Eliminar Abono a Proveedor en el sistema'],
            ...
            ['nombre' => 'Crear Caja', 'slug' => 'cash-registers.create', 'is_menu' => 0, 'icon' => 'fa-solid fa-vault', 'module' => 'Ventas', 'order' => 26, 'descripcion' => 'Permite Crear Caja en el sistema'],
            ['nombre' => 'Guardar Caja', 'slug' => 'cash-registers.store', 'is_menu' => 0, 'icon' => 'fa-solid fa-vault', 'module' => 'Ventas', 'order' => 26, 'descripcion' => 'Permite Guardar Caja en el sistema'],
            ['nombre' => 'Ver Detalle Caja', 'slug' => 'cash-registers.show', 'is_menu' => 0, 'icon' => 'fa-solid fa-vault', 'module' => 'Ventas', 'order' => 26, 'descripcion' => 'Permite Ver Detalle Caja en el sistema'],
            ['nombre' => 'Editar Caja', 'slug' => 'cash-registers.edit', 'is_menu' => 0, 'icon' => 'fa-solid fa-vault', 'module' => 'Ventas', 'order' => 26, 'descripcion' => 'Permite Editar Caja en el sistema'],
            ['nombre' => 'Actualizar Caja', 'slug' => 'cash-registers.update', 'is_menu' => 0, 'icon' => 'fa-solid fa-vault', 'module' => 'Ventas', 'order' => 26, 'descripcion' => 'Permite Actualizar Caja en el sistema'],
            ['nombre' => 'Eliminar Caja', 'slug' => 'cash-registers.destroy', 'is_menu' => 0, 'icon' => 'fa-solid fa-vault', 'module' => 'Ventas', 'order' => 26, 'descripcion' => 'Permite Eliminar Caja en el sistema'],
            ['nombre' => 'Cierre Caja', 'slug' => 'cash-registers.close-form', 'is_menu' => 0, 'icon' => 'fa-solid fa-vault', 'module' => 'Ventas', 'order' => 26, 'descripcion' => 'Permite Cierre Caja en el sistema'],
            ['nombre' => 'Cerrar Caja', 'slug' => 'cash-registers.close', 'is_menu' => 0, 'icon' => 'fa-solid fa-vault', 'module' => 'Ventas', 'order' => 26, 'descripcion' => 'Permite Cerrar Caja en el sistema'],
            ...
            ['nombre' => 'Editar Asistencia', 'slug' => 'attendance.edit', 'is_menu' => 0, 'icon' => 'fa-solid fa-calendar-check', 'module' => 'Configuración', 'order' => 105, 'descripcion' => 'Permite Editar Asistencia en el sistema'],
            ['nombre' => 'Actualizar Asistencia', 'slug' => 'attendance.update', 'is_menu' => 0, 'icon' => 'fa-solid fa-calendar-check', 'module' => 'Configuración', 'order' => 105, 'descripcion' => 'Permite Actualizar Asistencia en el sistema'],
            ['nombre' => 'Eliminar Asistencia', 'slug' => 'attendance.destroy', 'is_menu' => 0, 'icon' => 'fa-solid fa-calendar-check', 'module' => 'Configuración', 'order' => 105, 'descripcion' => 'Permite Eliminar Asistencia en el sistema'],
