    ...
    <div class="row h-100 g-0 position-relative">
        ...
        <div class="col-lg-4 cart-sidebar" id="cartSidebar">
            <div class="cart-header">
                <div>
                    <h5 class="fw-extrabold text-slate-800 mb-0">Cotización Nueva</h5>
                    <span class="text-muted small">Nro. Previsto #{{ str_pad($nextNroCotizacion, 6, '0', STR_PAD_LEFT) }}</span>
                </div>
            ...
            <div class="p-3 bg-slate-50" style="background: #f8fafc;">
                ...
                <div class="mb-0">
                    ...
                    <input type="date" id="expiration_date" class="form-control border-0 shadow-sm rounded-4 py-2 px-3" value="{{ now()->addDays(15)->format('Y-m-d') }}">
                </div>
            </div>
            ...
            <div class="checkout-footer">
                <div class="mb-4">
                    ...
                    <textarea id="notes" class="form-control border-0 bg-slate-100 rounded-4 p-3" rows="2" placeholder="Términos, condiciones, observaciones..." style="background: #f1f5f9;"></textarea>
                </div>
                ...
                <button id="btnSaveQuote" class="btn-pay-action d-flex align-items-center justify-content-center" disabled>
