...
<div id="quotes-create-page" data-config='@json($config)'></div>
    ...
    <div class="row h-100 g-0 position-relative">
        ...
        <div class="col-lg-8 product-panel">
            ...
            <div class="search-header">
                <div class="position-relative flex-grow-1">
                    ...
                    <input type="text" id="productSearch" class="form-control pos-search-input py-3" placeholder="Buscar productos por nombre, código o categoría...">
                </div>
        ...
        <div class="col-lg-4 cart-sidebar" id="cartSidebar">
            <div class="cart-header">
                <div>
                    <h5 class="fw-extrabold text-slate-800 mb-0">Editar Cotización</h5>
                    <span class="text-muted small">#{{ $quote->nro_cotizacion }}</span>
                </div>
            ...
            <div class="p-3 bg-slate-50" style="background: #f8fafc;">
                ...
                <div class="mb-0">
                    <label class="form-label small fw-bold text-slate-500 mb-1">VALIDEZ HASTA</label>
                    <input type="date" id="expiration_date" class="form-control border-0 shadow-sm rounded-4 py-2 px-3" value="{{ $quote->expiration_date ? $quote->expiration_date->format('Y-m-d') : now()->addDays(15)->format('Y-m-d') }}">
                </div>
            </div>

            <div class="cart-items-scroll flex-grow-1" id="cartItems">
                <div class="text-center py-5 text-muted opacity-40 d-none" id="emptyCart">
                    <i class="fas fa-file-invoice fa-4x mb-3"></i>
                    <h6 class="fw-bold">Sin productos seleccionados</h6>
                    <p class="small">Añade productos para cotizar</p>
                </div>
            </div>

            <div class="checkout-footer">
                <div class="mb-4">
                    <label class="form-label small fw-bold text-slate-500 mb-1 caps-letter-spacing">NOTAS ADICIONALES</label>
                    <textarea id="notes" class="form-control border-0 bg-slate-100 rounded-4 p-3" rows="2" placeholder="Términos, condiciones, observaciones..." style="background: #f1f5f9;">{{ $quote->notes }}</textarea>
                </div>
                ...
                <button id="btnSaveQuote" class="btn-pay-action d-flex align-items-center justify-content-center">
...
<template id="cartItemTemplate">
    <div class="cart-item-modern shadow-sm">
        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="text-end">
                <div class="text-muted small item-price-unit" style="font-size: 0.7rem;"></div>
