                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control rounded-3 p-3 @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name', $expense->name) }}" placeholder="Ej: Pago de luz, Artículos oficina..." required>
                                    @error('name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control rounded-3 p-3" id="reference" name="reference" value="{{ old('reference', $expense->reference) }}" placeholder="Nro Factura / Recibo / Transacción">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 border-start-md ps-md-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control rounded-3 p-3 @error('date') is-invalid @enderror" id="date" name="date" value="{{ old('date', $expense->date->format('Y-m-d')) }}" required>
                                    @error('date')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" step="0.01" class="form-control rounded-end-3 py-3 border-start-0 ps-0 @error('amount') is-invalid @enderror" id="amount" name="amount" value="{{ old('amount', $expense->amount) }}" placeholder="0.00" required>
                                    </div>
                                    @error('amount')
                                 ...
                                 <div class="mb-3">
                                    ...
                                    <textarea class="form-control rounded-3" id="description" name="description" rows="4" placeholder="Detalles extra sobre este gasto...">{{ old('description', $expense->description) }}</textarea>
                                </div>
                            </div>
                        </div>
