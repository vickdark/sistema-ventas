    ...
    <div class="wrapper">
        <div class="container">
            ...
            <div class="content">
                ...
                <p style="margin-top: 25px;">Si no has creado una cuenta, no es necesario realizar ninguna otra acción.</p>
                
                <p>Saludos,<br>{{ $businessName }}</p>

                <hr style="border: 0; border-top: 1px solid #e2e8f0; margin: 30px 0;">
                <p style="font-size: 0.85rem; color: #64748b;">
                    Si tienes problemas al hacer clic en el botón "Verificar Correo Electrónico", copia y pega la siguiente URL en tu navegador: 
                    <br>
